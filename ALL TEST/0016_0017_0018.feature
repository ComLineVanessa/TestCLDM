...
Функционал: Постановка на учет. Заказ на производство. Сценарий. Молочная продукция ВЕС. Типография. Три линии агрегации
...
И в поле с именем 'Комментарий' я ввожу текст 'Сценарий. Молочная продукция ВЕС. Типография. Три линии агрегации'
...
И в таблице "Товары" из выпадающего списка с именем "ТоварыТипИспользуемыхКодовМаркировки" я выбираю точное значение 'Создаваемые в посту укладки'
